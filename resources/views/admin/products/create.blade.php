                    ...
                    <div class="card-body">
                        <div class="col-md-6 mx-auto">
                            <form action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control @error('qty') is-invalid @enderror" id="floatingInput" name="qty" placeholder="Quantity" value="{{old('qty')}}">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="floatingInput" name="price" placeholder="Price" value="{{old('price')}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="10" class="form-control summernote @error('desc') is-invalid @enderror" id="floatingInput" name="desc" placeholder="Description">{{old('desc')}}</textarea>
                                    @error('desc')
                                    <span class="invalid-feedback">
                                          <strong>{{$message}}</strong>
                                    </span>
